...
```
!source <(curl -s https://raw.githubusercontent.com/conjure-cp/conjure-notebook/v0.0.11/scripts/install-colab.sh)
%reload_ext conjure
```
...
```
%pip install --quiet git+https://github.com/conjure-cp/conjure-notebook.git@v0.0.11
%reload_ext conjure
```
